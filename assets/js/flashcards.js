export async function initFlashcards() {
    ...
    const type = document.querySelector('#deckType');
    const count = document.querySelector('#deckCount');
    const question = document.querySelector('#deckQuestion');
    const verdict = document.querySelector('#deckVerdict');
    const answer = document.querySelector('#deckAnswer');
    const dots = document.querySelector('#deckDots');
    function render() {
