export function initNavigation() {
    ...
    const orbit = document.querySelector('#cursorOrbit');
    ...
    const railLinks = [...document.querySelectorAll('.protocol-rail a')];
    ...
    document.querySelectorAll('[data-section].section').forEach(section => sectionObserver.observe(section));
}
